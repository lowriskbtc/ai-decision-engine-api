...
class RunbookGenerator:
    ...
    def __init__(self):
        self.runbook_file = "OPERATIONAL_RUNBOOK.md"
...
"""
        ...
        with open(self.runbook_file, "w", encoding="utf-8") as f:
            f.write(runbook)
        
        print(f"Runbook generated: {self.runbook_file}")

def main():
    """Generate runbook"""
    generator = RunbookGenerator()
    generator.generate_runbook()
